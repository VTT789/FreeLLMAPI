...
# Debug: Check if better-sqlite3 exists and where
RUN ls -la /app/server/node_modules/ | grep better-sqlite3 || echo "Module not found in /app/server/node_modules"

# Insert keys with debug logging
